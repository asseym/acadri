SmartListing.configure do |config|
  ...
  config.constants :classes, {
    ...
    :icon_new              => "fa fa-plus",
    :icon_edit             => "fa fa-pencil-square-o fa-lg",
    :icon_trash            => "fa fa-trash fa-lg",
    :icon_sort_none        => "fa fa-minus fa-lg",
    :icon_sort_up          => "fa fa-sort-up fa-lg",
    :icon_sort_down        => "fa fa-sort-desc fa-lg",
