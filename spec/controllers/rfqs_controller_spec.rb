...
RSpec.describe RfqsController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new rfq as @rfq" do
      ...
      expect(assigns(:rfq)).to be_a_new(Rfq)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created rfq as @rfq" do
        post :create, {:rfq => valid_attributes}, valid_session
        expect(assigns(:rfq)).to be_a(Rfq)
        expect(assigns(:rfq)).to be_persisted
      end

      it "redirects to the created rfq" do
        post :create, {:rfq => valid_attributes}, valid_session
        expect(response).to redirect_to(Rfq.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved rfq as @rfq" do
        post :create, {:rfq => invalid_attributes}, valid_session
        expect(assigns(:rfq)).to be_a_new(Rfq)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested rfq" do
        rfq = Rfq.create! valid_attributes
        put :update, {:id => rfq.to_param, :rfq => new_attributes}, valid_session
        rfq.reload
      ...
      it "redirects to the rfq" do
        rfq = Rfq.create! valid_attributes
        put :update, {:id => rfq.to_param, :rfq => valid_attributes}, valid_session
        expect(response).to redirect_to(rfq)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the rfq as @rfq" do
        rfq = Rfq.create! valid_attributes
        put :update, {:id => rfq.to_param, :rfq => invalid_attributes}, valid_session
        expect(assigns(:rfq)).to eq(rfq)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the rfqs list" do
      rfq = Rfq.create! valid_attributes
      delete :destroy, {:id => rfq.to_param}, valid_session
      expect(response).to redirect_to(rfqs_url)
    end
  end
